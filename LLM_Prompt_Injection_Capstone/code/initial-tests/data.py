class Data:
    ...
    "pretend", "act", "assume", "become", "simulate",
    "reveal", "show", "display", "print", "expose",
    "run", "execute", "invoke", "delete", "remove",
    "access", "read", "write", "extract", "dump",
    "repeat", "echo", "return", "format", "encode",
    "circumvent", "evade", "unlock", "disable"
]

    PROMPT_INJECTION_PATTERNS = [
        r'(ignore|disregard) (all )?(previous|prior) instructions',
